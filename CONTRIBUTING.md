...
This outlines how to propose a change to USAboundaries. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ropensci/USAboundaries", fork = TRUE)`.
...
Please note that the USAboundaries project is released with a
